...
所以你会发现在程序中, #我们还时不时出现什么染色体, DNA, 遗传, DNA交叉, 变异 这些东西. 不过想想也能明白, 在自然界中, 优胜劣汰, 我们人类也是靠着这些手段一步步从#猴子

<img class="course-image" src="/static/results/ML_intro/genetic-algorithm2.png">

~变成#会敲键盘, 会唱歌, 会读书, 会干坏事的猴子了. 哈哈. 重点不是这些. 我们应该正儿八经地想想, 我们是怎么样一步一步变成后面这些猴子的.
...
<img class="course-image" src="/static/results/ML_intro/genetic-algorithm6.png">
