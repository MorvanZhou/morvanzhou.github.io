...
<img class="course-image" src="/static/results/ML_intro/auto2.png">

假设刚刚那个神经网络是这样, 对应上刚刚的图片, 可以看出图片其实是经过了压缩,再解压的这一道工序. 当压缩的时候, 原有的图片质量被缩减, 解压时用信息量小却包含了所有关键信息的文件恢复出原本的图片. 为什么要这样做呢?

<img class="course-image" src="/static/results/ML_intro/auto3.png">
...
<img class="course-image" src="/static/results/ML_intro/auto5.png">
