...
thumbnail: "/static/thumbnail/rl/4.3 DQN3.jpg"
...
<img class="course-image" src="/static/results/rl/4-3-1.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/rl/4-3-2.png" alt="{{ page.title }}{% increment image-count %}">

最后提供一种修改版的 [DQN 代码](https://github.com/MorvanZhou/Reinforcement-learning-with-tensorflow/blob/master/contents/5_Deep_Q_Network/DQN_modified.py),
