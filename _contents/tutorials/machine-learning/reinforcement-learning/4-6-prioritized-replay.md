...
* 学习资料:
  ...
  * [本教程基于的 Paper](https://arxiv.org/abs/1511.05952)
...
可以想象 Natural DQN 会话很久的时间学习, 因为记忆库中只有很少很少的 +10 reward 可以学习. 正负样本不一样.
...
没能一开始很快拿到 `r=+10` 样本, 但是它高效的样本学习法, 弥补了这个不幸运, 并很快地超越了 natural DQN 的, 学习得更快.
