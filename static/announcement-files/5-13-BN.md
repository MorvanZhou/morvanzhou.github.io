...
<h2 class="tut-h2-pad" id="BN">什么是 Batch Normalization</h2>
...
<h2 class="tut-h2-pad" id="build-net">搭建网络</h2>
...
<h2 class="tut-h2-pad" id="make-data">创建数据</h2>
...
<h2 class="tut-h2-pad" id="BN-code">Batch Normalization 代码</h2>
...
<h2 class="tut-h2-pad" id="compare">对比有无 BN</h2>
