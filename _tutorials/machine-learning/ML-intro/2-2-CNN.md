...
<img class="course-image" src="/static/results/ML-intro/cnn1.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/cnn3.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/cnn4.png" alt="{{ page.title }}{% increment image-count %}">
