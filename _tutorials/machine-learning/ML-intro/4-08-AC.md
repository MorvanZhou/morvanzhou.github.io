...
<img class="course-image" src="/static/results/ML-intro/AC1.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/AC2.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/AC3.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/AC4.png" alt="{{ page.title }}{% increment image-count %}">
