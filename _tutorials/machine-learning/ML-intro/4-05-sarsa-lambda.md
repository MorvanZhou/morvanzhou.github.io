...
<img class="course-image" src="/static/results/ML-intro/sl1.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/sl2.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/sl3.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/sl4.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/sl5.png" alt="{{ page.title }}{% increment image-count %}">
