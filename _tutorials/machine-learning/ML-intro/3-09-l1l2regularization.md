...
<img class="course-image" src="/static/results/ML-intro/L1l2regularization2.png"  width="500px">
...
<img class="course-image" src="/static/results/ML-intro/L1l2regularization3.png"  width="500px">
...
<img class="course-image" src="/static/results/ML-intro/L1l2regularization4.png"  width="500px">
...
<img class="course-image" src="/static/results/ML-intro/L1l2regularization5.png"  width="500px">
...
<img class="course-image" src="/static/results/ML-intro/L1l2regularization6.png"  width="500px">

L2 针对于这种变动, 白点的移动不会太大, 而 L1的白点则可能跳到许多不同的地方 , 因为这些地方的总误差都是差不多的. 侧面说明了 L1 解的不稳定性.

 {% include assign-heading.html %}

<img class="course-image" src="/static/results/ML-intro/L1l2regularization7.png"  width="500px">
