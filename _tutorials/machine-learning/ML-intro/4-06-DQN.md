...
<img class="course-image" src="/static/results/ML-intro/DQN1.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/DQN2.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/DQN3.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/DQN4.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/DQN5.png" alt="{{ page.title }}{% increment image-count %}">
