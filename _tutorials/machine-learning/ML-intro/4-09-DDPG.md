...
<img class="course-image" src="/static/results/ML-intro/ddpg2.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/ddpg3.png" alt="{{ page.title }}{% increment image-count %}">
...
<img class="course-image" src="/static/results/ML-intro/ddpg4.png" alt="{{ page.title }}{% increment image-count %}">
